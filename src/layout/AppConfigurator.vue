...
<template>
  <div
    class="config-panel absolute right-0 top-[3.25rem] hidden w-64 origin-top border bg-surface-0 p-4 shadow-[0px_3px_5px_rgba(0,0,0,0.02),0px_0px_2px_rgba(0,0,0,0.05),0px_1px_4px_rgba(0,0,0,0.08)] border-surface rounded-border dark:bg-surface-900"
  >
