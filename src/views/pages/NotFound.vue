  ...
  <div class="flex min-h-screen items-center justify-center overflow-hidden">
    <div class="flex flex-col items-center justify-center">
      ...
      >
        ...
        >
          <span class="text-3xl font-bold text-primary">404</span>
          <h1
            class="mb-2 text-3xl font-bold text-surface-900 lg:text-5xl dark:text-surface-0"
          >
            Not Found
          </h1>
          <div class="mb-8 text-surface-600 dark:text-surface-200">
            Requested resource is not available.
          </div>
          <router-link
            to="/"
            class="flex w-full items-center border-b border-surface-300 py-8 dark:border-surface-500"
          >
            <span
              class="flex items-center justify-center border-2 border-primary text-primary rounded-border"
            ...
            <span class="ml-6 flex flex-col">
              <span
                class="mb-0 block font-medium text-surface-900 lg:text-xl dark:text-surface-0"
                >Frequently Asked Questions</span
              >
              <span class="text-surface-600 lg:text-xl dark:text-surface-200"
          ...
          >
            ...
            <span class="ml-6 flex flex-col">
              <span
                class="mb-0 font-medium text-surface-900 lg:text-xl dark:text-surface-0"
          ...
          <router-link
            to="/"
            class="mb-8 flex w-full items-center border-b border-surface-300 py-8 dark:border-surface-500"
          >
            <span
              class="flex items-center justify-center border-2 border-primary text-primary rounded-border"
              style="height: 3.5rem; width: 3.5rem"
