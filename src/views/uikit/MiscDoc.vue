    ...
    <div class="md:w-1/2">
      ...
      <div class="card">
        ...
        <div class="flex flex-col items-center sm:flex-row">
          <Chip label="Action" class="mb-2 mr-2"></Chip>
          <Chip label="Comedy" class="mb-2 mr-2"></Chip>
          <Chip label="Mystery" class="mb-2 mr-2"></Chip>
          <Chip label="Thriller" :removable="true" class="mb-2"></Chip>
        </div>

        <div class="my-4 font-semibold">Icon</div>
        <div class="flex flex-col items-center sm:flex-row">
          <Chip label="Apple" icon="pi pi-apple" class="mb-2 mr-2"></Chip>
          <Chip label="Facebook" icon="pi pi-facebook" class="mb-2 mr-2"></Chip>
          <Chip label="Google" icon="pi pi-google" class="mb-2 mr-2"></Chip>
          <Chip
            label="Microsoft"
